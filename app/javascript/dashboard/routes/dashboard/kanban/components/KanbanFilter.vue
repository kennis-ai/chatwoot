...
const savedFilters = computed(() => {
  const filters = JSON.parse(
    localStorage.getItem('kanban_saved_filters') || '[]'
  );
...
const applyFilters = async () => {
  ...
  console.log(
    '[KanbanFilter] applyFilters - Filtros limpos antes do emit:',
    cleanFilters
  );
  ...
  try {
    ...
    console.log(
      '[KanbanFilter] applyFilters - Resposta da API:',
      response.data
    );
...
watch(
  ...
  newFilters => {
    console.log(
      '[KanbanFilter] watch initialFilters - newFilters recebidos:',
      newFilters
    );
    if (newFilters) {
      ...
      console.log(
        '[KanbanFilter] watch initialFilters - filters atualizados:',
        filters.value
      );
    } else {
  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        >
          <div
            class="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[calc(90vh+20px)] overflow-hidden border border-slate-100 dark:border-slate-800"
          >
            <!-- Header -->
            ...
            <div
              ...
              :style="{
                minHeight: showSavedFiltersDropdown ? '700px' : 'auto',
              }"
            >
              <!-- Error message -->
              <div
                  ...
                  <div class="relative">
                    <button
                      ...
                      :style="{
                        ...
                        border: showQuickFiltersDropdown
                          ? '2px solid #93C5FD'
                          : '1px solid #3B82F6',
                      }"
                    ...
                    >
                      <div class="flex items-center gap-3">
                        ...
                        <span class="text-white">{{
                          selectedQuickFilter ||
                          t('KANBAN.FILTER.SELECT_QUICK_FILTER')
                        }}</span>
                      </div>
                      <svg
                      ...
                      >
                        <div class="max-h-60 overflow-y-auto p-2 space-y-2">
                          ...
                          >
                            ...
                            <div
                              class="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            />
                            ...
                            <div class="relative flex items-center gap-4 p-4">
                              ...
                              <div class="flex-shrink-0 relative">
                                <div
                                  class="w-8 h-8 rounded-md flex items-center justify-center transition-all duration-200 shadow-sm text-white group-hover:shadow-md group-hover:scale-110"
                                  :style="{ backgroundColor: filter.color }"
                                  :class="[
                                    selectedQuickFilterValue === filter.value &&
                                      'ring-2 ring-white/30 ring-offset-1 ring-offset-slate-100 dark:ring-offset-slate-800',
                                  ]"
                                >
                                  <component
                                    :is="filter.icon"
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="flex gap-3 items-stretch">
                      <input
                        ...
                        type="text"
                        :placeholder="
                          t('KANBAN.FILTER.FILTER_NAME_PLACEHOLDER')
                        "
                    ...
                    <div class="relative">
                      <button
                        ...
                        :style="{
                          backgroundColor: savedFiltersButtonHover
                            ? '#1D4ED8'
                            : '#2563EB',
                          border: showSavedFiltersDropdown
                            ? '2px solid #93C5FD'
                            : '1px solid #3B82F6',
                        }"
                      ...
                      >
                        <div class="flex items-center gap-3">
                          ...
                          <span class="text-white">{{
                            selectedSavedFilter ||
                            t('KANBAN.FILTER.LOAD_SAVED_FILTER')
                          }}</span>
                        </div>
                        <svg
                          class="w-5 h-5 transition-transform duration-200"
                        ...
                        >
                          <div class="max-h-60 overflow-y-auto p-2 space-y-2">
                            <div
                              ...
                              class="text-center text-slate-500 dark:text-slate-400 py-4 text-sm"
                            >
                            ...
                            <div
                              ...
                              :key="filter.name"
                              class="group relative overflow-hidden rounded-xl border transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-slate-300 dark:hover:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 hover:shadow-sm"
                            >
                              <!-- Background gradient effect -->
                              <div
                                class="absolute inset-0 bg-gradient-to-r from-transparent via-slate-100/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                              />
                              ...
                              <div class="relative flex items-center p-4">
                                ...
                                <div class="flex-1 min-w-0 text-left">
                                  <div
                                    class="font-semibold text-sm text-slate-900 dark:text-slate-200"
                                  >
                                    {{ filter.name }}
                                  </div>
                                  <div
                ...
                <div v-show="!showSavedFiltersDropdown">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button
                      ...
                      :key="priority.value"
                      class="px-4 py-2 text-sm font-medium rounded-full transition-all duration-200 transform hover:scale-105 active:scale-95"
                      :class="[
                        selectedPriorities &&
                ...
                <div v-show="!showSavedFiltersDropdown">
                  ...
                  <div class="mt-3 max-h-48 overflow-y-auto">
                    <div
                      ...
                      @click="
                        filters.agent =
                          filters.agent === agent.id ? '' : agent.id
                      "
                    >
                      <div class="relative flex items-center gap-4 p-4">
                        <!-- Avatar -->
                    ...
                    <div
                      v-if="agents.length === 0 && agentSearchQuery"
                      class="text-center text-slate-500 dark:text-slate-400 py-6 text-sm"
                    >
                      <svg
            ...
            <!-- Footer -->
            <div
              v-show="!showSavedFiltersDropdown"
              ...
              <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <button
                    ...
                    :style="
                      hasActiveFilters && !isFilteringItems
                        ? {
                  ...
                  >
                    ...
                    <span>{{
                      isFilteringItems
                        ? t('KANBAN.FILTER.FILTERING')
                        : t('KANBAN.FILTER.APPLY_FILTERS')
                    }}</span>
                    <svg
