    ...
    <div class="w-full max-w-md">
      ...
      <div class="p-6">
        <div class="grid grid-cols-2 gap-4">
          ...
          >
            <i
              class="i-lucide-check-circle h-12 w-12 text-green-600 dark:text-green-400"
            />
            <span
          ...
          >
            <i
              class="i-lucide-x-circle h-12 w-12 text-red-600 dark:text-red-400"
            />
      ...
      <!-- Footer -->
      <div
        class="flex items-center justify-end border-t border-slate-200 p-6 dark:border-slate-700"
      >
