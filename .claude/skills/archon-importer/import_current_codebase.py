...
async def import_current_codebase(
    ...
    Args:
        ...
        project_id: Optional existing project ID to import into
    ...
    config = {
        ...
        "project_id": project_id,  # Optional existing project to import into
        "doc_patterns": [
            "*.md",
            "*.rst",
            "*.txt",
...
async def main():
    ...
    parser.add_argument(
        "--project-id",
        help="Existing Archon project ID to import into (optional)",
    )
